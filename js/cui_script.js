jQuery(document).ready(function ($) {
    ...
    $(document).delegate('.cui-media-btns a', 'click', function (e) {
      ...
      $modalHtml = '<div id="cui-modal-wrap"><span id="cui-modal-close"></span><div id="cui-modal-header"><h3 id="cui-modal-title">TÃ­tulo</h3></div><div id="cui-modal-content"><p>Hola</p></div><div id="cui-modal-footer"><a id="cui-modal-ok-' + post_id + '" class="cui-modal-ok cui-modal-btn" href="#">' + CUI.accept + '</a><a class="cui-modal-cancel cui-modal-btn" href="#">' + CUI.cancel + '</a></div></div>';
      ...
      if (typeof jQuery.fn.jPages == 'function' && CUI.jpages == 'true') {
        ...
        if (num_comments > $numPerPage) {
          ...
          jQuery($holder).show().jPages({
            containerID: $idList,
            previous: "â† " + CUI_WP.textNavPrev,
            next: CUI_WP.textNavNext + " â†’",
